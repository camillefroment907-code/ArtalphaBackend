              ...
              <div style={{ padding: '22px 26px' }}>
                ...
                {(() => {
                  ...
                  const houses = price >= 100000 ? [
                    { name: "Christie's", avg: '€297 748', lots: '199 268', score: 96, url: 'https://www.christies.com/selling-services/auction-estimates?utm_source=nautilus&utm_medium=referral&utm_campaign=sell_modal', contact: 'sellingservices@christies.com', specialty: currentLang === 'fr' ? 'Art contemporain · Blue chip' : 'Contemporary art · Blue chip', tag: currentLang === 'fr' ? 'Recommandé' : 'Recommended' },
                    { name: "Sotheby's", avg: '€225 228', lots: '291 060', score: 93, url: 'https://www.sothebys.com/en/sell?utm_source=nautilus&utm_medium=referral&utm_campaign=sell_modal', contact: 'consign@sothebys.com', specialty: currentLang === 'fr' ? 'Art moderne · International' : 'Modern art · International', tag: null },
                    { name: 'Phillips', avg: '€136 986', lots: '55 220', score: 84, url: 'https://www.phillips.com/sell?utm_source=nautilus&utm_medium=referral&utm_campaign=sell_modal', contact: 'consignments@phillips.com', specialty: currentLang === 'fr' ? 'Art contemporain · Émergent' : 'Contemporary · Emerging', tag: null },
                  ] : price >= 20000 ? [
                    { name: 'Phillips', avg: '€136 986', lots: '55 220', score: 94, url: 'https://www.phillips.com/sell?utm_source=nautilus&utm_medium=referral&utm_campaign=sell_modal', contact: 'consignments@phillips.com', specialty: currentLang === 'fr' ? 'Art contemporain · Émergent' : 'Contemporary · Emerging', tag: currentLang === 'fr' ? 'Recommandé' : 'Recommended' },
                    { name: 'Bonhams', avg: '€20 063', lots: '45 586', score: 87, url: 'https://sell.bonhams.com/?utm_source=nautilus&utm_medium=referral&utm_campaign=sell_modal', contact: 'paris.art@bonhams.com', specialty: currentLang === 'fr' ? 'Art britannique · Européen' : 'British · European art', tag: null },
                    { name: 'Dorotheum', avg: '€30 206', lots: '10 655', score: 79, url: 'https://www.dorotheum.com/en/sell/?utm_source=nautilus&utm_medium=referral&utm_campaign=sell_modal', contact: 'office@dorotheum.at', specialty: currentLang === 'fr' ? 'Art européen · Vienne' : 'European art · Vienna', tag: null },
                  ] : [
                    { name: 'Artcurial', avg: '€25 064', lots: '20 980', score: 92, url: 'https://www.artcurial.com/vente-achat/vendre-avec-artcurial?utm_source=nautilus&utm_medium=referral&utm_campaign=sell_modal', contact: 'vendre@artcurial.com', specialty: currentLang === 'fr' ? 'Art français · Moderne' : 'French · Modern art', tag: currentLang === 'fr' ? 'Recommandé' : 'Recommended' },
                    { name: 'Cornette de Saint Cyr', avg: '€15 922', lots: '10 424', score: 85, url: 'https://csc.bonhams.com/vendre?utm_source=nautilus&utm_medium=referral&utm_campaign=sell_modal', contact: 'paris@bonhams.com', specialty: currentLang === 'fr' ? 'Art contemporain français' : 'French contemporary art', tag: null },
                    { name: 'Bonhams', avg: '€20 063', lots: '45 586', score: 78, url: 'https://sell.bonhams.com/?utm_source=nautilus&utm_medium=referral&utm_campaign=sell_modal', contact: 'paris.art@bonhams.com', specialty: currentLang === 'fr' ? 'Art britannique · Accessible' : 'British art · Accessible', tag: null },
                  ];
                  return (
