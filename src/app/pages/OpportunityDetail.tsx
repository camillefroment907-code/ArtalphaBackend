            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              {(() => {
                ...
                const cfgMap: Record<string, { accent: string; bg: string; border: string; label: string; sub: string }> = {
                  ...
                  sold:      { accent: '#4ade80', bg: 'rgba(34,197,94,0.08)',            border: 'rgba(34,197,94,0.2)',            label: isFr ? '✓  Adjugé'      : '✓  Sold',     sub: lot.hammer_price ? (isFr ? `Prix réalisé : ${fmtExact(lot.hammer_price)}` : `Hammer price: ${fmtExact(lot.hammer_price)}`) : (isFr ? 'Ce lot a été vendu aux enchères' : 'This lot was sold at auction') },
