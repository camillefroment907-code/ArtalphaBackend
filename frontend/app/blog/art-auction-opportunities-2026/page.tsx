...
export const metadata: Metadata = {
  title: 'The Best Art Auction Opportunities in 2026 · Nautilus',
  description:
    'Where and how to find the best opportunities in the art auction market in 2026. A complete guide to sales worth tracking.',
  alternates: {
    canonical: 'https://get-nautilus.com/blog/art-auction-opportunities-2026',
    languages: {
      'fr': '/blog/opportunites-encheres-2026',
    },
  },
  openGraph: {
    title: 'The Best Art Auction Opportunities in 2026',
    description:
      'Where and how to find the best opportunities in the art auction market in 2026.',
    type: 'article',
    locale: 'en_US',
    url: 'https://get-nautilus.com/blog/art-auction-opportunities-2026',
    siteName: 'Nautilus',
  },
};
...
export default function ArticleArtAuctionOpportunities2026() {
  return (
    <>
