      ...
      <div className="flex-1 lg:max-w-sm xl:max-w-md flex flex-col justify-center px-8 lg:px-10 bg-[#0f0e0d] border-l border-white/[0.06]">
        ...
        >
          ...
          <a
            ...
            className="w-full flex items-center justify-center gap-3 py-3 border border-white/15 rounded-sm text-sm text-stone-300 hover:bg-white/[0.04] hover:border-white/25 transition-all duration-200 mb-4"
          >
